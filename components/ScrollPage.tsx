...
export const DivContainer = forwardRef(({ children }, ref) => (
  <>
    ...
    <section className="flex items-center h-[100vh] relative text-lg uppercase pl-[10%] mb-20 pb-20 pr-[10%] pt-[100px] font-neue text-[#ffeded]">
      <Skills />
    </section>

    <section className="flex items-center h-[100vh] relative text-lg uppercase pl-[10%] mb-20 pb-20  pr-[10%] text-[#ffeded] justify-end">
      <Projects />
    </section>
    ...
    <section className="flex items-center h-[20vh] relative text-lg uppercase pl-[10%] pr-[10%]text-[#ffeded]">
      <Copyright />
    </section>
  </>
));
